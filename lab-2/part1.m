...
draw3plots(Im_average3, Im_average7, Im_average31, 'Average blurring');
draw3plots(Im_sharpened_avrg3, Im_sharpened_avrg7, Im_sharpened_avrg31, 'Average sharpening');
...
draw3plots(Im_disk3, Im_disk7, Im_disk31, 'Disk blurring');
draw3plots(Im_sharpened_disk3, Im_sharpened_disk7, Im_sharpened_disk31, 'Disk sharpening');
...
draw3plots(Im_gauss3, Im_gauss7, Im_gauss31, 'Gaussian blurring');
draw3plots(Im_sharpened_gauss3, Im_sharpened_gauss7, Im_sharpened_gauss31, 'Gaussian sharpening');

% a band pass filter, based on average
Im_filter_band3 = imfilter(Im_average3, filter_sharpened_avrg3);
Im_filter_band7 = imfilter(Im_average7, filter_sharpened_avrg7);
Im_filter_band31 = imfilter(Im_average31, filter_sharpened_avrg31);
draw3plots(Im_filter_band3, Im_filter_band7, Im_filter_band31, 'Band pass filter');

% draw the three passed images in a new figure
function draw3plots(Im1, Im2, Im3, title)
